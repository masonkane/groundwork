        ...
        <section className="relative overflow-hidden">
          ...
          <div className="bg-[var(--black)] mesh-gradient-dark grain-overlay text-white relative px-4 sm:px-6 py-16 sm:py-24">
            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
              ...
              {/* Stats row */}
              <div className="grid grid-cols-3 gap-2 sm:gap-4 max-w-xl mx-auto mb-8 sm:mb-10">
                {[
                  ...
                  <div key={s.label} className="text-center min-w-0">
                    <div className="text-xl sm:text-2xl md:text-3xl font-extrabold mb-1 truncate">{s.num}</div>
