...
export default function QuickWinsPage() {
  ...
  const [checkedSteps, setCheckedSteps] = useState<Record<string, boolean>>(() => {
    ...
    try {
      const saved = localStorage.getItem('gw_quickwin_steps');
      return saved ? JSON.parse(saved) : {};
    } catch { return {}; }
  });

  useEffect(() => {
    localStorage.setItem('gw_quickwin_steps', JSON.stringify(checkedSteps));
  }, [checkedSteps]);
