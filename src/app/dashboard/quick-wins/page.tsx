...
const wins = [
  ...
  { title: "AI-Powered Proposal Generator", impact: "$1,500/mo", impactNum: 1500, effort: "Low", time: "1-2 weeks", category: "Sales", description: "Generate professional electrical service proposals in 10 minutes instead of 2+ hours. AI pulls from your pricing database, customizes scope based on project type (panel upgrades, new construction, service work), and creates polished documents that close faster.", tools: ["PandaDoc", "Proposify", "Qwilr"], steps: ["Export your top 10 winning proposals as templates", "Upload your rate card and standard scope descriptions", "Configure dynamic pricing fields by service type", "Set up e-signature integration for instant close", "Test with 5 real proposals and refine templates", "Roll out to all estimators with a 30-minute training"] },
  { title: "Automated Safety Compliance Tracking", impact: "$900/mo", impactNum: 900, effort: "Low", time: "1 week", category: "Operations", description: "AI tracks crew certifications, OSHA training expiration dates, and job site safety requirements automatically. Sends alerts 30 days before expirations and generates compliance reports for inspectors on demand.", tools: ["SafetyCulture", "Procore", "ComplianceQuest"], steps: ["List all required certifications per role (journeyman, apprentice, foreman)", "Upload current certification records and expiration dates", "Configure 30-day and 7-day expiration alerts", "Set up automated compliance report generation", "Train field supervisors on the mobile app (15 minutes)", "Schedule monthly compliance review with auto-generated dashboard"] },
  { title: "Smart Material Ordering", impact: "$1,200/mo", impactNum: 1200, effort: "Low", time: "1-2 weeks", category: "Operations", description: "AI analyzes your job schedules and historical material usage to auto-generate purchase orders. Eliminates emergency supply runs (which cost 20-30% more) and reduces material waste by predicting exact quantities needed per job.", tools: ["Sortly Pro", "Fishbowl", "inFlow"], steps: ["Export last 12 months of material purchase data", "Map top 50 materials to job types (panel work, rough-in, trim, service)", "Set up reorder triggers based on upcoming job schedule", "Configure auto-PO generation for standard materials", "Enable supplier price comparison for orders over $500", "Monitor waste reduction and cost savings weekly for first month"] },
];
